      ...
      <div className="max-w-6xl mx-auto">
        ...
        <div className="mb-12 p-8 bg-gradient-to-r from-[#77160e] to-[#c11720] rounded-2xl text-white text-center">
          <h3 className="mb-3 text-white">
            <b>{language === "nl" ? "Tijdschema" : "Schedule"}</b>
          </h3>
          <div className="grid sm:grid-cols-3 gap-6 max-w-3xl mx-auto">
            <div>
              <div className="opacity-90">12:30 - 18:00</div>
              <div>{language === "nl" ? "Expo" : "Exhibition"}</div>
            </div>
            <div>
              <div className="opacity-90">{language === "nl" ? "Doorlopend" : "Continuous"}</div>
              <div>Food and Drinks</div>
            </div>
            <div>
              <div className="opacity-90">18:00 - ...</div>
        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8 mb-12">
          <div className="p-6 bg-gray-50 rounded-xl">
            ...
            <h3 className="mb-2">
              <b>{language === "nl" ? "Datum & Tijd" : "Date & Time"}</b>
            </h3>
            <p className="text-gray-600">{t("common.date")}</p>
            <p className="text-gray-600">
              {language === "nl" ? "Vanaf 12u30!" : "Starting from 12:30 PM!"}
            </p>
          </div>
          ...
          <div className="p-6 bg-gray-50 rounded-xl">
            ...
            <h3 className="mb-2">
              <b>{language === "nl" ? "Locatie" : "Location"}</b>
            </h3>
          ...
          <div className="p-6 bg-gray-50 rounded-xl">
            ...
            <h3 className="mb-2">
              <b>{language === "nl" ? "Toegang" : "Access"}</b>
            </h3>
            <p className="text-gray-600">
              {language === "nl"
                ? "Gratis entree voor de expo"
                : "Free entrance for the exhibition"}
            </p>
            <p className="text-gray-600">
              {language === "nl"
                ? "Workshops voor bedrijven: neem contact op"
                : "Workshops for companies: contact us"}
            </p>
            <p className="text-gray-600">
              {language === "nl"
          ...
          <div className="grid md:grid-cols-3 gap-6">
            <div className="p-6 border border-gray-200 rounded-xl">
              <div className="flex items-center gap-3 mb-3">
                ...
                <h4>
                  <b>{language === "nl" ? "Met de auto" : "By car"}</b>
                </h4>
              </div>
            ...
            <div className="p-6 border border-gray-200 rounded-xl">
              <div className="flex items-center gap-3 mb-3">
                ...
                <h4>
                  <b>{language === "nl" ? "Met het openbaar vervoer" : "By public transport"}</b>
                </h4>
              </div>
            ...
            <div className="p-6 border border-gray-200 rounded-xl">
              <div className="flex items-center gap-3 mb-3">
                ...
                <h4>
                  <b>{language === "nl" ? "Met de fiets" : "By bike"}</b>
                </h4>
              </div>
              <p className="text-gray-600 text-sm">
                {language === "nl"
              ...
              <div>
                ...
                <ul className="space-y-1 text-gray-700 text-sm">
                  <li>
                    •{" "}
                    {language === "nl"
                      ? "Rolstoeltoegankelijk (lift aanwezig)"
                      : "Wheelchair accessible (lift present)"}
                  </li>
                  <li>• {language === "nl" ? "Toegankelijke toiletten" : "Accessible toilets"}</li>
                  <li>
                    • {language === "nl" ? "Assistentiehonden welkom" : "Assistance dogs welcome"}
                  </li>
                  <li>
                    • {language === "nl" ? "Rustige ruimte beschikbaar" : "Quiet room available"}
                  </li>
                </ul>
              </div>
            </div>
