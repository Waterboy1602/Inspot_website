...
import teamPhoto from "figma:asset/abe172c6f924ffb65991953da7e279b7d6f53ac1.png";
        ...
        <div className="mt-20 max-w-4xl mx-auto">
          ...
          <div className="bg-gray-50 rounded-2xl p-8 md:p-12 text-center">
            <p className="text-lg text-gray-700 mb-6 leading-relaxed">
              {language === 'nl' 
                ? <>InSpot is een evenement van tweedejaarsstudenten <a href="https://www.vives.be/nl/handelswetenschappen-en-bedrijfskunde/cultuurmanagement" target="_blank" rel="noopener noreferrer" className="text-[#c11720] hover:underline font-semibold">Cultuurmanagement</a> uit VIVES Brugge.</>
                : <>InSpot is an event organized by second-year <a href="https://www.vives.be/nl/handelswetenschappen-en-bedrijfskunde/cultuurmanagement" target="_blank" rel="noopener noreferrer" className="text-[#c11720] hover:underline font-semibold">Culture Management</a> students from VIVES Bruges.</>}
            </p>
          ...
          <div className="mt-8 overflow-hidden rounded-2xl shadow-lg">
            <ImageWithFallback
              src={teamPhoto}
              alt={language === 'nl' ? "InSpot Team - Studenten Cultuurmanagement VIVES Brugge" : "InSpot Team - Culture Management Students VIVES Bruges"}
