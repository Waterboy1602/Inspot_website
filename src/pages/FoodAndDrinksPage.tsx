    ...
    <div className="min-h-screen bg-white">
      ...
      <div className="max-w-4xl mx-auto px-4 py-16">
        ...
        <div className="prose max-w-none">
          ...
          <h3 className="mb-4 text-[#c11720]"><b>{language === 'nl' ? 'Wat kun je verwachten?' : 'What to expect?'}</b></h3>
          <ul className="space-y-3 mb-8">
            <li className="flex items-start gap-2 text-gray-700">
              <span className="text-[#c11720] mt-1">•</span>
              <span>{language === 'nl' ? 'Frisdranken en alcoholvrije alternatieven' : 'Soft drinks and non-alcoholic alternatives'}</span>
            </li>
            <li className="flex items-start gap-2 text-gray-700">
              <span className="text-[#c11720] mt-1">•</span>
              <span>{language === 'nl' ? 'Selectie van lokale bieren en wijnen' : 'Selection of local beers and wines'}</span>
            </li>
            <li className="flex items-start gap-2 text-gray-700">
              <span className="text-[#c11720] mt-1">•</span>
            ...
            <li className="flex items-start gap-2 text-gray-700">
              <span className="text-[#c11720] mt-1">•</span>
              <span>{language === 'nl' ? 'Aperitiefplanken (beperkt in aanbod!)' : 'Aperitif boards (limited supply!)'}</span>
            </li>
            <li className="flex items-start gap-2 text-gray-700">
              <span className="text-[#c11720] mt-1">•</span>
              <span>{language === 'nl' ? 'Vegetarische opties beschikbaar' : 'Vegetarian options available'}</span>
            </li>
            <li className="flex items-start gap-2 text-gray-700">
              <span className="text-[#c11720] mt-1">•</span>
              <span>{language === 'nl' 
                ...
                : 'Allergies or questions regarding the food and drink offer? Feel free to contact us via email: inspot.scmc@outlook.be!'}</span>
            </li>
          </ul>

          <div className="bg-gray-50 p-6 rounded-xl mb-8">
            <h3 className="mb-3 text-[#77160e]">{language === 'nl' ? 'Zakelijk arrangement' : 'Corporate packages'}</h3>
            <p className="text-gray-700 mb-0">
              ...
              <a href="mailto:inspot.scmc@outlook.be" className="text-[#c11720] hover:underline">
