      ...
      <div className="max-w-4xl mx-auto px-4 py-16">
        <div className="prose max-w-none">
          ...
          <div className="grid md:grid-cols-2 gap-8 mb-12">
            <div className="bg-gray-50 p-6 rounded-xl">
              <div className="flex items-center gap-3 mb-4">
                ...
                <h3 className="mb-0 text-[#77160e]">
                  <b>{language === "nl" ? "Burlesque dansen" : "Burlesque dancing"}</b>
                </h3>
              </div>
            ...
            <div className="bg-gray-50 p-6 rounded-xl">
              <div className="flex items-center gap-3 mb-4">
                ...
                <h3 className="mb-0 text-[#77160e]">
                  <s>
                    <b>{language === "nl" ? "Houtbranden" : "Wood burning"}</b>
                  </s>{" "}
                  {language === "nl" ? "Gekozen!" : "Chosen!"}
                </h3>
              </div>
              <p className="text-gray-700 mb-0">
                {language === "nl"
          ...
          <h2 className="mb-4 text-[#77160e] text-center text-4xl md:text-5xl">
            {language === "nl" ? (
              <>
                Kies voor een <b>all-in formule!</b>
              </>
            ) : (
              <>
                Choose an <b>all-in formula!</b>
              </>
            )}
          </h2>
          ...
          <ul className="space-y-3 mb-8">
            <li className="flex items-start gap-2 text-gray-700">
              ...
              <span>
                {language === "nl" ? (
                  <>
                    Aperitief met <b>tapasplank</b>: vanaf 17u30
                  </>
                ) : (
                  <>
                    Aperitif with <b>tapas board</b>: from 5:30 PM
                  </>
                )}
              </span>
            </li>
            <li className="flex items-start gap-2 text-gray-700">
              ...
              <span>
                {language === "nl" ? (
                  <>
                    Een <b>inspirerende workshop</b>, exclusief voor uw team: van 18u00 tot 20u00
                  </>
                ) : (
                  <>
                    An <b>inspiring workshop</b>, exclusive to your team: from 6:00 PM to 8:00 PM
                  </>
                )}
              </span>
            </li>
            <li className="flex items-start gap-2 text-gray-700">
              ...
              <span>
                {language === "nl" ? (
                  <>
                    Een <b>pastamaaltijd</b> om 20u00
                  </>
                ) : (
                  <>
                    A <b>pasta meal</b> at 8:00 PM
                  </>
                )}
              </span>
            </li>
            <li className="flex items-start gap-2 text-gray-700">
              ...
              <span>
                {language === "nl" ? (
                  <>
                    <b>Gratis toegang</b> tot de geplande concerten: vanaf 20u00
                  </>
                ) : (
                  <>
                    <b>Free access</b> to the planned concerts: from 8:00 PM
                  </>
                )}
              </span>
            </li>
            <li className="flex items-start gap-2 text-gray-700">
              ...
              <span>
                {language === "nl" ? (
                  <>
                    Toegang to de <b>InSpot-expositie</b> (doorlopend)
                  </>
                ) : (
                  <>
                    Access to the <b>InSpot exhibition</b> (continuous)
                  </>
                )}
              </span>
            </li>
          ...
          <div className="bg-blue-50 border-l-4 border-[#669bbb] p-6 rounded-lg mb-8">
            <div className="flex items-start gap-3">
              ...
              <p className="text-gray-700 mb-0">
                ...
                {language === "nl" ? (
                  <>
                    zin om al vroeger in de sfeer te komen? Zak dan al vroeger af naar het Entrepot
                    af en pik het <b>Happy Hour </b>(16u30 - 17u30) mee!
                  </>
                ) : (
                  <>
                    feel like getting into the mood earlier? Head over to Het Entrepot early and
                    catch the <b>Happy Hour</b> (4:30 PM - 5:30 PM)!
                  </>
                )}
              </p>
            </div>
